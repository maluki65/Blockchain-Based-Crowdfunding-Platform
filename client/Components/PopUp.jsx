    ...
    <>
      ...
      focus:outline-none'>
        <div className='relative w-auto my-6 mx-auto max-w-3xl'>
          ...
          focus:outline-none'>
            {/*header*/}
            <div className=' flex items-start justify-between p-5 border-b boader-solid border-slate-200 rounded-t'>
            ...
            <div className='flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b'>
              ...
              <button
                className='background text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3
                rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all 
                duration-150'
                type='button'
